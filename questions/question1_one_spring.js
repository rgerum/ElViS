...
<p>In the <b>virtual lab</b>, you can experiment with a spring. Change the <b>spring constant $$k$$</b> and stretch the spring by a length <b>displacements $$d$$</b>.</p>
 
<p>Observe the output <b>force $$F$$</b> and derive an equation connecting $$F$$, $$k$$ and $$d$$.</p>
<p>What force $$F$$ is generated by a spring with <b>spring constant</b> $$k$$ when it is <b>stretched</b> by a length $$d$$?</p>
`;
        this.test_cases = [{
            "name": "Spring (k = 1 N/m)",
            "plot_point": 1,
